...
let upperC= challenge.toUpperCase();
console. log(upperC);

//Change all the string characters to lowercase letters using toLowerCase() method
let lowerC= challenge.toLowerCase();
console. log(lowerC);

//Cut (slice) out the first word of the string using substr() or substring() method

console. log(challenge. substr(0,3));
//using the substring()method for the same purpose
...
let group= /a/gi
console.log(challenge.match(group));
...
//se repeat() method to print 30 Days Of JavaScript 2 times
